...
@Component({
  selector: 'app-merchant-user-new',
  templateUrl: './merchant-user-new.component.html',
  styleUrls: ['./merchant-user-new.component.scss']
})
export class MerchantUserNewComponent extends FormBaseComponent implements OnInit {
  ...
  ngOnInit() {
    this.breadcrumbService.setItems([{ name: 'Merchant Users', slug: '/panel/merchantusers' }, { name: 'New' }]);
  ...
  submit() {
    if (this.formGroup.valid) {
      ...
      this.merchantUserService.save(this.merchantUser).subscribe(() => {
